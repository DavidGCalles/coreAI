...
## Tareas
- [x] Auditar los mapeos de volúmenes en el `docker-compose.yml` para garantizar que la data de PostgreSQL, la base de datos vectorial y Redis persisten físicamente en el host.
- [x] Refactorizar la configuración de redes (`networks`) creando una topología `bridge` estricta.
- [x] Aplicar reglas de red: el contenedor de la base de datos relacional y la vectorial no deben tener salida a internet bajo ninguna circunstancia.
